...
<head>
    ...
    <title>Café el amor - Contact</title>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-4">
                    ...
                    <p>Email:
                        <strong><a href="mailto:cafeelamor@contact.com">cafeelamor@contact.com</a></strong>
                    </p>
                    <p>Address:
                        <strong>Raisina Rd, Alahawas,
                          <br>Sector 59, Gurugram, Haryana 122011</strong>
                    </p>
                </div>
                    ...
                    <form role="form">
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label>Name</label>
                                <input type="text" id="fname" name="fname" maxlength="45" class="form-control">
                            </div>
                            <div class="form-group col-lg-4">
                            ...
                            <div class="form-group col-lg-12">
                                <label>Message</label>
                                <textarea class="form-control" id="message" name="message" maxlength="200" rows="6"></textarea>
                            </div>
                            <div class="form-group col-lg-12">
